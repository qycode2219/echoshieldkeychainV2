...
const demos = [
  {
    ...
    description: "EcoShield Keychain V2 boleh digantung pada beg sekolah, beg galas atau kunci dan sesuai digunakan semasa aktiviti luar.",
  },
  {
    image: "/demo-structure.png",
    title: "Reka Bentuk Produk",
    description: "Menunjukkan struktur dalaman EcoShield Keychain V2 serta ruang untuk repellent pouch yang boleh diganti.",
  },
  {
    image: "/demo-ingredients.jpg",
    title: "Bahan Semula Jadi",
    description: "Menggunakan bahan semula jadi seperti serai wangi, pudina, cengkih dan kulit lemon sebagai penghalau serangga.",
  },
];
